pipeline {
    environment {
        nexusRegapp = "52.91.226.221:8082/devops-training-app"
        nexusRegdb = "52.91.226.221:8082/devops-training-db"
        nexusRegapi = "52.91.226.221:8082/devops-training-api"
        nexusReg = "52.91.226.221:8082"
    }
    agent {
        node {
            label 'prod-stage'
