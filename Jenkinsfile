pipeline {
    environment {
        nexusRegapp = "44.199.209.223:8082/devops-training-app"
        nexusRegdb = "44.199.209.223:8082/devops-training-db"
        nexusRegapi = "44.199.209.223:8082/devops-training-api"
        nexusReg = "44.199.209.223:8082"
    }
    agent {
        node {
            label 'prod-stage'
